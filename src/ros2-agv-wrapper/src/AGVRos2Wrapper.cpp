...
// 	current_speed_timer = nh->createTimer(rclcpp::Duration(1.0/current_speed_hz),
...
// void AgvROSWrapper::publishCurrentSpeed(const rclcpp::TimerEvent &event){
// 	double * vel;
...
// void AgvROSWrapper::callbackCouplingControl(const rclcpp::TimerEvent &event){
